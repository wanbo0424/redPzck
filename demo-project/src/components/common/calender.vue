  ...
  <div class="mywk__calendar">
    ...
    <div class="calendar">
      ...
      <div class="calendar__main">
        ...
        <div :class="`main__block ${(item.type === 'pre' || item.type === 'next') ? 'main__block-not' : ''} ${(item.content === selectedDate && item.type === 'normal') ? 'main__block-today' : '' } ${(item.content === new Date().getDate())? 'main__block-today' : '' }`"
